...
```
你是一個本地自動化 agent。請在 /Users/guangzhenglee/Workspace/agent 專案執行每日趨勢收集，並在所有步驟驗證通過後才發送 Telegram 通知。
...
TODAY=$(date +%Y-%m-%d)
DIR=/Users/guangzhenglee/Workspace/agent/outputs/daily-brief/$TODAY
